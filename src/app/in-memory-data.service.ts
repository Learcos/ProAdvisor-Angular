...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const entreprises: Entreprise[] = [
      ...
      new Entreprise(6, 'Pro chauffage', 2.8, [categories[2]], "" ),
    ...
    const commentaires: Commentaire[] = [
      ...
      new Commentaire(2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
                      entreprises[0], 4, new Date('December 17, 2018'), true, auteurs[0] ),
      ...
      new Commentaire( 5, 'Cool', entreprises[2], 4, new Date('December 17, 2018 03:24:00'), true),
      new Commentaire( 6, 'Cool', entreprises[3], 4, new Date('December 17, 2018 03:24:00'), true, auteurs[3]),
      ...
      new Commentaire(9, 'Cool', entreprises[5], 4, new Date('December 17, 2018 03:24:00'), false, auteurs[4]),
      ...
      new Commentaire(13, 'Cool', entreprises[6], 4, new Date('December 17, 2018 06:24:00'), false, auteurs[7]),
      ...
      new Commentaire(31,  'Cool',  entreprises[17],  4,  new Date('December 17, 2018 03:24:00')),
      new Commentaire(32,  'Cool',  entreprises[18],  4,  new Date('December 17, 2018 03:24:00'), false),
      ...
      new Commentaire(35,  'Cool',  entreprises[20],  4,  new Date('December 17, 2018 03:24:00')),
