...
export class InMemoryDataService {
  /*createDb() {
    ...
    const adresses: Adresse[] = [
      new Adresse ("Metz", 49.07880, 6.102168, null, null, "France"),
      new Adresse ("Nancy", 48.41380, 6.11586, 'Meuse', null, 'France'),
      new Adresse ("Marseille", 43.174902, 5.225185),
      new Adresse ("Bordeaux", 44.502558, 0.344980),
      new Adresse ("Nice", 43.421127, 7.155789),
      new Adresse ("Aix-en-Provence", 43.314188, 5.265903),
      new Adresse ("Strasbourg", 48.35211, 7.444391),
      new Adresse ("Valence", 44.555999, 4.54),
      new Adresse ("Montpellier", 43.363931, 3.523803),
      new Adresse ("Lyon", 45.445446, 4.504816),
      new Adresse ("Arles", 42.272354, 2.38445),
      new Adresse ("La Grave", 45.0610969, 6.218565),
      new Adresse ("Borny", 49.105735, 6.227196, 'Moselle'),
      new Adresse ("Amnéville", 49.152696, 6.083131),
      new Adresse ("Rouen",49.263527, 1.055755),
    ];

    const entreprises: Entreprise[] = [
      new Entreprise(1, 'Gégé-Peinture', 3.5, [categories[0]], adresses[0]),
      new Entreprise(2, 'Jacques-Peinture', 1.6, [categories[0]], adresses[2]),
      new Entreprise(3, 'Van Gogh Peinture', 2, [categories[0]], adresses[1] ),
      new Entreprise(4, 'Archigram', 3.5, [categories[0], categories[1]], adresses[3], "Archi top", null, "entrepriseIndividuelle"),
      ...
      new Entreprise(7, 'Pro toiture', 4, [categories[3]], adresses[2]),
      new Entreprise(8, 'Pro-Menuiserie', 3.6, [categories[4]], null, null, null, ),
      new Entreprise(9, 'Passion moto', 1.6, [categories[0], categories[2], categories[4]], adresses[7]),
      new Entreprise(10, 'Passion auto', 1.6, [categories[5]], adresses[2] ),
      new Entreprise(11, 'Passion auto moto', 5, [categories[5]], adresses[3] ),
      new Entreprise(12, 'Passion jardin', 1.6, [categories[6]], adresses[8] ),
      new Entreprise(13, 'Passion panneaux', 5, [categories[7]], adresses[3] ),
      new Entreprise(14, 'Passion solaire', 4.6, [categories[7]], adresses[7]),
      new Entreprise(15, 'Passion isolation', 3.6, [categories[8]], adresses[11] ),
      new Entreprise(16, 'Passion aména', 1.6, [categories[9]], adresses[2]),
      new Entreprise(17, 'Passion gement', 2.1, [categories[9]], adresses[3] ),
      new Entreprise(18, 'Passion inté', 1.6, [categories[9]], adresses[4] ),
      new Entreprise(19, 'Passion rieur', 2.3, [categories[9]], adresses[5] ),
      new Entreprise(20, 'Passion éolien', 1.6, [categories[10]], adresses[6]),
      new Entreprise(21, 'Passion énergie', 1.6, [categories[11]], adresses[2]),
    ];
